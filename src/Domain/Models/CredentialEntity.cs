...
public class CredentialEntity
{
    ...
    [Column("resource_name")] public string ResourceName { get; set; } = string.Empty;

    [Column("resource_login")] public string ResourceLogin { get; set; } = string.Empty;
    ...
    [Column("changed_at")] public DateTimeOffset? ChangedAt { get; set; }
